...
var webp_1 = require("../libwebp/dist/webp");
var load_binary_data_1 = require("./load-binary-data");
var detect_webp_support_1 = require("./detect-webp-support");
...
var WebpMachine = /** @class */ (function () {
    function WebpMachine(_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.webp, webp = _c === void 0 ? new webp_1.Webp() : _c, _d = _b.webpSupport, webpSupport = _d === void 0 ? detect_webp_support_1.detectWebpSupport() : _d;
        this.busy = false;
        this.cache = {};
        this.webp = webp;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.busy)
                            throw new Error("webp-machine decode error: busy");
                        this.busy = true;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 3:
                        error_1 = _a.sent();
                        this.busy = false;
                        error_1.message = "webp-machine decode error: " + error_1.message;
                        throw error_1;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 5, , 6]);
                        return [4 /*yield*/, load_binary_data_1.loadBinaryData(src)];
                    case 3:
                        webpData = _a.sent();
                    ...
                    case 5:
                        error_2 = _a.sent();
                        error_2.message = "webp-machine polyfillImage failed: " + error_2.message;
                        throw error_2;
